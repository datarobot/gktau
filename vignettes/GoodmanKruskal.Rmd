...
\end{eqnarray}
$$
These equations form the basis for the function **GKtau** included in the GoodmanKruskal package.  
...
## 6. Regrouping categorical variables
